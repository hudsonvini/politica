      ...
      <div className={style.gridProposta}>
        ...
        <article className={style.card}>
          ...
          <div className={style.areaInformation}>
            ...
            <h3>
              Decidi entrar na politica depois de ver tanta desigualdade onde eu
              vivia.
            </h3>
            ...
            <p className={fontSecundaria.className}>
              ...
              mandatos e chegou ao Senado em 2011, sendo eleito novamente em
              2018. Desde 2013, Ciro Nogueira preside o Progressistas, um dos
